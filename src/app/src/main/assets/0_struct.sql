...
CREATE TABLE LIEU
   (
   LIEU_ID INTEGER AUTO_INCREMENT ,
...
CREATE TABLE PAYS
   (
   PAY_CODE INTEGER AUTO_INCREMENT,
...
CREATE TABLE MARQUE
   (
   MAR_CODE INTEGER AUTO_INCREMENT ,
   MAR_LIBELLE VARCHAR(50)  
,
     PRIMARY KEY (MAR_CODE)
   );
...
CREATE TABLE LABEL
   (
   LAB_CODE INTEGER AUTO_INCREMENT,
...
CREATE TABLE CATEGORIE
   (
   CAT_CODE INTEGER AUTO_INCREMENT,
...
CREATE TABLE MAGASIN
   (
   MAG_CODE INTEGER AUTO_INCREMENT,
   MAG_LIBELLE VARCHAR(32)  
,
     PRIMARY KEY (MAG_CODE)
   );

CREATE TABLE ALLERGENE
   (
   ALL_CODE INTEGER AUTO_INCREMENT ,
   ALL_LIBELLE VARCHAR(32)  
,
     PRIMARY KEY (ALL_CODE)
   );

CREATE TABLE CONDITIONNEMENT
   (
   CON_CODE INTEGER AUTO_INCREMENT,
